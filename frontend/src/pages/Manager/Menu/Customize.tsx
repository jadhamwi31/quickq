...
export default function Customize() {
    ...
    const updateMenu = (Style: String) => {
        const filteredArray: any[] = Styles.filter((element: any) => element.name === Style);
        ...
        setCategoryBackgroundColor(filteredArray[0].styles.category.BackgroundColor)
        ...
        <div className="row">
            <div className="col-8">
                <div className="GeneralItem scroll " style={{ padding: "0px" }} >
                    <div id="accordion">
                        <div className="card" style={{ border: "1px #F0F0EF ", borderRadius: "10px 10px 0px 0px" }}>
                            <div id="headingOne">
                                <h6 className="mb-0">
                                    <button data-toggle="collapse" style={{
                                        width: "100%",
                                        textAlign: "left",
                                        padding: "15px",
                            ...
                            <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div className="card-body" style={{ padding: "20px" }}>
                                    <table width="100%"><tbody>
                                        <tr>
                                            <td width="80%" height="40px">  <label>Primary  Color</label></td>
                                            <td style={{ textAlign: "center" }}><input type="color" value={bodyPrimaryColor} onChange={(e) => setBodyPrimaryColor(e.target.value)} /></td>
                                        </tr>
                                        <tr>
                                            <td width="80%" height="40px">  <label>Secondary Color</label></td>
                                            <td style={{ textAlign: "center" }}><input type="color" value={bodySecondaryColor} onChange={(e) => setbodySecondaryColor(e.target.value)} /></td>
                                        </tr>
                                        <tr>
                                            <td width="80%" height="40px">  <label>Background Color</label></td>
                                            <td style={{ textAlign: "center" }}><input type="color" value={bodyBackgroundColor} onChange={(e) => setBodyBackgroundColor(e.target.value)} /></td>
                                        </tr>
                                    </tbody>
                                    </table>
                                </div>
                        ...
                        <div className="card" style={{ border: "1px #F0F0EF ", borderRadius: "0px" }}>
                            <h6 className="mb-0">
                                <button style={{
                                    width: "100%",
                                    textAlign: "left",
                        ...
                        <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div className="card-body" style={{ padding: "20px" }}>
                                <table width="100%"><tbody>
                                    <tr>
                                        <td width="80%" height="40px">  <label>Background Color</label></td>
                                        <td style={{ textAlign: "center" }}><input type="color" value={categoryBackgroundColor} onChange={(e) => setCategoryBackgroundColor(e.target.value)} /></td>
                                    </tr>
                                    <tr>
                                        <td width="80%" height="40px"> <label>Text Color</label></td>
                                        <td style={{ textAlign: "center" }}><input type="color" value={categoryColor} onChange={(e) => setCategoryColor(e.target.value)} /></td>
                                    </tr>
                                    <tr>
                                        <td width="80%" height="40px">  <label>Text Align</label></td>
                                        <td>
                                            <select
                                                style={{ marginInline: 'auto' }}
                                                className="form-select shadow-none"
                                                value={categoryTextAlign}
                                                onChange={(e) => setCategoryTextAlign(e.target.value as TextAlign)}
                                            >
                                    ...
                                    <tr>
                                        <td width="80%" height="40px">
                                            <label>Font </label></td>
                                        <td>
                                            <select style={{ marginInline: "auto" }} className="form-select shadow-none" value={categoryFontFamily} onChange={(e) => setCategoryFontFamily(e.target.value)}>
                                    ...
                                    <tr>
                                        <td width="80%" height="40px"> <label><b>Bold</b></label></td>
                                        <td>
                                            <input
                                    ...
                                    <tr>
                                        <td width="80%" height="40px"> <label><i>Italic</i></label></td>
                                        <td>
                                            <input
                                                style={{ cursor: "pointer", marginInline: "auto", display: "block" }}
                                                className="form-check-input"
                        ...
                        <div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                            <div className="card-body" style={{ padding: "20px" }}>
                                <table width="100%"><tbody>
                                    <tr>
                                        <td width="80%" height="40px">  <label>Background Color</label></td>
                                        <td style={{ textAlign: "center" }}><input type="color" value={itemBackgroundColor} onChange={(e) => setItemBackgroundColor(e.target.value)} /></td>
                                    </tr>
                                    <tr>
                                        <td width="80%" height="40px"> <label>Text Color</label></td>
                                        <td style={{ textAlign: "center" }}><input type="color" value={itemColor} onChange={(e) => setItemColor(e.target.value)} /></td>
                                    </tr>
                                    <tr>
                                        <td width="80%" height="40px">  <label>Text Align</label></td>
                                        <td>
                                            <select
                                                ...
                                                className="form-select shadow-none"
                                                value={itemTextAlign}
                                                onChange={(e) => setItemTextAlign(e.target.value as TextAlign)}
                                            >
                                                <option value="">Choose</option>
                                                <option value="left">Left</option>
                                                <option value="center">Center</option>
                                    ...
                                    <tr>
                                        <td width="80%" height="40px">
                                            <label>Font </label></td>
                                        <td>
                                            <select style={{ marginInline: "auto" }} className="form-select shadow-none" value={itemFontFamily} onChange={(e) => setItemFontFamily(e.target.value)}>
                                                <option style={{ fontFamily: "Arial" }}>Arial</option>
                                                <option style={{ fontFamily: "Brush Script MT" }}>Brush Script MT</option>
                                                <option style={{ fontFamily: "Helvetica" }}>Helvetica</option>
                                                <option style={{ fontFamily: "Georgia" }}>Georgia</option>
                    ...
                    <div className="input-group mb-3 mt-3  ml-3 p-3">
                        ...
                        <input width="60%" type="text" style={{
                            borderRadius: "5px 0px 0px 5px"
                        }} className='form-control shadow-non' value={styleName} onChange={(e) => {
                            setStyleName(e.target.value)
                        }} required />
                        <button className='btn btn-primary' onClick={() => { addStyle() }}> Add</button>
                    </div>
                    ...
                    <div className="input-group mb-3 mt-3  ml-3 p-3">
                        ...
                        <button className='btn btn-primary' onClick={() => { selectStyle() }}> Select</button>
            ...
            <div className="col-4" >
                <div className="GeneralItem" style={{
                    height: "69vh",
                    borderRadius: "15px",
                    padding: "0px",
                    position: "relative",
                    ...
                    <div style={{
                        ...
                        <i style={{ fontSize: "30px", color: bodySecondaryColor }} className="bi bi-arrow-left"></i>
                    </div>
                    <div>
                        <h4 style={{
                            color: categoryColor,
                        ...
                        <table width="100%" style={{
                            ...
                            <tbody>
                                <tr style={{
                                    ...
                                    <td>
                                        <img width="150px" src={placeholder} alt='' style={{ padding: "15px", }} />
                                    </td>
                                    <td >
                                        <h4 style={{
                                            ...
                                            fontWeight: itemFontWeight === "bold" ? "bold" : "normal"
                    ...
                    <div style={{
                        ...
                        }}> <i className="bi bi-book" ></i>Menu</a>
                        <a href='#' style={{
                            display: "flex",
                            flexDirection: "column",
                            textDecoration: "none",
                            ...
                            width: "80px",
                            paddingTop: "5px",
                        }}> <i className="bi bi-star"></i>promo</a>
                        <a href='#' style={{
                            display: "flex",
                            flexDirection: "column",
                            textDecoration: "none",
                            ...
                            width: "80px",
                            paddingTop: "5px",
                        }}> <i className="bi bi-file-earmark-text"></i>Order</a>
                        <a href='#' style={{
                            display: "flex",
                            flexDirection: "column",
                            textDecoration: "none",
                            ...
                            width: "80px",
                            paddingTop: "5px",
                        }}> <i className="bi bi-cash-coin"></i>Payment</a>
